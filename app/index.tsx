...
export default function HomeScreen() {
  ...
  const hasSkills = cvData.skills.length > 0; // 🔹 Nueva constante para Skills
  ...
  return (
    ...
    >
      ...
      {/* 🔹 Aquí agregué la sección de Skills usando la constante hasSkills */}
      <View style={styles.section}>
        ...
        {hasSkills && (
          <View style={{ marginTop: 8 }}>
            {cvData.skills.map((skill) => (
              <Text key={skill.id} style={{ fontSize: 14, marginBottom: 2 }}>
